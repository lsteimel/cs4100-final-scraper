...
export const TWITTER_BEARER_TOKEN = 'AAAAAAAAAAAAAAAAAAAAAFXzAwAAAAAAMHCxpeSDG1gLNLghVe8d74hl6k4%3DRUMF4xAQLsbeBhTSRrCiQpJtxoGWeyHrDb5te2jpGskWDFW82F';
...
export type RequestManagerConstructor = {
    proxies?: string[],
    credentials?: TwitterGuestAccountCredentials[]
};
